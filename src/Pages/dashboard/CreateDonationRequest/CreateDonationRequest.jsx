...
const CreateDonationRequest = () => {
    ...
    const onSubmit = async (data) => {
        ...
        // now post 
        axiosSecure.post('/donation-request', requestInfo)
            .then(res => {
        ...
        <div className="hero min-h-screen">
            <div className="hero-content p-0 flex-col lg:flex-row md:w-3/4 ">
                ...
                <div className="card shrink-0 w-full max-w-sm md:max-w-xl shadow-2xl bg-base-100">
                    <h1 className="text-2xl px-5 font-bold text-center mt-6">Create Donation Request</h1>
                    <form className="card-body" onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <div className="form-control mt-3">
                            <input className="btn btn-outline text-white bg-[#D1A054]" type="submit" value="Create Request" />
                        </div>
